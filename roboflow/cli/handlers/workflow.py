...
def register(subparsers: argparse._SubParsersAction) -> None:  # type: ignore[type-arg]
    ...
    version_list_p.set_defaults(func=_stub)
    ...
    fork_p.set_defaults(func=_stub)
    ...
    build_p.set_defaults(func=_stub)
